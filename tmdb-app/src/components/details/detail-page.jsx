...
function DetailPage(props) {
  ...
  return (
    <Container className='main-container-details'>
      <IconButton
      ...
      <CardTitle movieId={props.movieId} lenguage={props.lenguage} />
      
      <Box className='details'>
        <Box
          className='videos-cast'
          style={{
            background: theme.details.cast.background,
            marginBottom: 0, // Elimina el espacio inferior
          }}
        >
          <Cast movieId={props.movieId} lenguage={props.lenguage} />
          <Videos movieId={props.movieId} lenguage={props.lenguage} />
        </Box>
        <CardInfo lg={props.lenguage} movieId={props.movieId} />
      </Box>
      ...
      <Box 
        sx={{ 
          width: '100%',
          background: theme.details.cast.background,
          marginTop: 0, // Elimina el espacio superior
        }}
      >
        <Images movieId={props.movieId} lenguage={props.lenguage} />
      </Box>
    </Container>
  );
}
